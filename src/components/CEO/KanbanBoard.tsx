...
const columns: Column[] = [
  {
    id: 'sales',
    title: 'المبيعات',
    statuses: ['draft', 'pending_ceo_review', 'returned_to_sales'],
  ...
  },
  {
    id: 'design',
    title: 'التصميم',
    statuses: ['pending_design', 'in_design', 'design_review', 'design_completed'],
  ...
  },
  {
    id: 'printing',
    title: 'الطباعة',
    statuses: ['pending_printing', 'in_printing', 'printing_completed'],
  ...
  },
  {
    id: 'accounting',
    title: 'الحسابات',
    statuses: ['pending_payment', 'payment_confirmed'],
  ...
  },
  {
    id: 'dispatch',
    title: 'الإرسال',
    statuses: ['pending_materials', 'materials_in_progress', 'materials_ready', 'ready_for_dispatch', 'in_dispatch', 'delivered'],
...
const statusLabels: Record<string, string> = {
  draft: 'مسودة',
  pending_ceo_review: 'بانتظار مراجعة المدير',
...
// ألوان حسب حالة الطلب
const statusColors: Record<string, string> = {
  // المبيعات - أصفر
  draft: 'border-yellow-400 bg-yellow-50',
  pending_ceo_review: 'border-orange-400 bg-orange-50',
  returned_to_sales: 'border-yellow-500 bg-yellow-100',
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
            <div>
              ...
              <p className="text-blue-100 mt-2 flex items-center gap-2">
                ...
                الطلبات بين الأقسام لتحديث حالتها
              </p>
            </div>
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                />
                <svg
                  className="absolute left-4 top-3.5 h-6 w-6 text-white/70"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
